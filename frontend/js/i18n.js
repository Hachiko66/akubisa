...
const LANGS = {
  id: {
    ...
    toast_posted: 'Berhasil diposting! 🎉',
    toast_updated: 'Diperbarui! ✅',
    toast_deleted: 'Berhasil dihapus!',
    toast_saved: 'Berhasil disimpan!',
    toast_copied: 'Link disalin!',
    toast_error: 'Terjadi kesalahan',
    err_save: 'Gagal menyimpan',
    err_send: 'Gagal mengirim',
    err_load: 'Gagal memuat',
    err_delete: 'Gagal menghapus',
    err_upload: 'Gagal upload',
    err_mode: 'Gagal mengganti mode',
    err_trx: 'Gagal membuat transaksi',
    err_portfolio: 'Gagal membuat portfolio',
    no_reviews: 'Belum ada ulasan',
    no_applicants: 'Belum ada pelamar',
    no_listings: 'Belum ada penawaran',
    no_transactions: 'Belum ada transaksi',
    no_messages: 'Belum ada pesan',
    no_bookmarks: 'Belum ada penawaran tersimpan',
    no_jobs: 'Belum ada kebutuhan',
    loading: 'Memuat...',
    btn_first_listing: '+ Buat Penawaran Pertama',
    btn_edit_listing: 'Edit Penawaran',
    btn_post_job_first: '+ Posting Kebutuhanmu',
    btn_give_review: '⭐ Beri Ulasan',
    trx_done: 'Transaksi Selesai',
    trx_title_short: 'Transaksi',
    trx_badge: '✅ Transaksi',
    trx_manual: '✏️ Manual',
    profile_no_city: 'Kota belum diisi',
    role_worker_badge: 'Pekerja ⚡',
    role_client_badge: 'Pencari 🔍',
    badge_worker: '⚡ PEKERJA',
    badge_client: '🔍 PENCARI',
    mode_worker: 'Mode Pekerja ⚡',
    mode_client: 'Mode Pencari 🔍',
    post_modal_title: 'Aku Bisa…',
    btn_post_now: '🚀 Posting Sekarang',
    uploading: '⏳ Mengupload...',
    change_photo: '📷 Ganti Foto',
    err_name_required: 'Nama tidak boleh kosong',
    profile_save: '💾 Simpan Perubahan',
    hero_stat_users: 'Pengguna',
    cat_listings: 'penawaran',
  },
  ...
  en: {
    ...
    err_mode: 'Failed to switch mode',
    err_trx: 'Failed to create transaction',
    err_portfolio: 'Failed to create portfolio',
    no_reviews: 'No reviews yet',
    no_applicants: 'No applicants yet',
    no_listings: 'No listings yet',
    no_transactions: 'No transactions yet',
    no_messages: 'No messages yet',
    no_bookmarks: 'No saved listings',
    no_jobs: 'No job requests yet',
    loading: 'Loading...',
    btn_first_listing: '+ Create First Listing',
    btn_edit_listing: 'Edit Listing',
    btn_post_job_first: '+ Post Your Need',
    btn_give_review: '⭐ Leave Review',
    trx_done: 'Transaction Complete',
    trx_title_short: 'Transaction',
    trx_badge: '✅ Transaction',
    trx_manual: '✏️ Manual',
    profile_no_city: 'City not set',
    role_worker_badge: 'Worker ⚡',
    role_client_badge: 'Client 🔍',
    badge_worker: '⚡ WORKER',
    badge_client: '🔍 CLIENT',
    mode_worker: 'Worker Mode ⚡',
    mode_client: 'Client Mode 🔍',
    post_modal_title: 'I Can…',
    ...
    boost_benefit: '⭐ Featured at the top of Explore page',
  }
};
