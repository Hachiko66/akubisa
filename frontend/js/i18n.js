...
const LANGS = {
  id: {
    ...
    login_left_title: 'Selamat datang',
    login_left_title_em: 'kembali.',
    login_left_desc: 'Masuk dan lanjutkan perjalananmu bersama ribuan talent Indonesia.',
    login_feat_1: 'Posting kemampuanmu dalam 2 menit',
    login_feat_2: 'Chat langsung dengan klien',
    login_feat_3: 'Bangun reputasi dengan ulasan',
    reg_left_title: 'Mulai',
    reg_left_title_em: 'hari ini.',
    reg_left_desc: 'Gratis selamanya. Tidak perlu kartu kredit. Daftar dalam 1 menit.',
    register_role_label: 'Saya ingin:',
    register_offer: 'Menawarkan Jasa',
    register_offer_sub: 'Posting kemampuanku',
    register_find: 'Mencari Talent',
    register_find_sub: 'Temukan penyedia jasa',
    register_name_label: 'Nama Lengkap *',
    label_city: 'Kota',
    label_phone: 'No. WhatsApp',
    login_testimonial: 'AkuBisa membantu saya dapat klien pertama dalam 3 hari. Platform terbaik untuk freelancer Indonesia!',
    job_title: '🙋 Aku Butuh',
    job_modal_title: '🙋 Aku Butuh...',
    btn_post_job_new: '+ Posting Kebutuhan',
    see_all: 'Lihat Semua →',
    how_simple: 'Sesederhana',
    how_simple_em: 'itu.',
    how_step_1_title: 'Tulis kemampuanmu',
    how_step_1_desc: 'Buat profil dan posting penawaran dalam 2 menit.',
    how_step_2_title: 'Ditemukan klien yang tepat',
    how_step_2_desc: 'Calon klien mencarimu lewat kategori dan pencarian.',
    how_step_3_title: 'Chat & mulai kolaborasi',
    how_step_3_desc: 'Diskusi langsung lewat platform, sepakati syarat, dan mulai bekerja.',
    cat_title: 'Semua bidang,',
    cat_title_2: 'diterima.',
    testi_label: 'Testimoni',
    testi_title: 'Mereka sudah',
    testi_title_2: 'membuktikannya.',
    cta_title: 'Siap mulai',
    cta_title_em: 'hari ini?',
    cta_desc: 'Bergabung dengan ribuan pekerja dan klien yang sudah membuktikan.',
    cta_btn_register: 'Daftar Gratis — Mulai Sekarang',
    cta_btn_explore: 'Lihat Penawaran',
    cta_note: 'Gratis selamanya · Tidak perlu kartu kredit · Daftar dalam 1 menit',
    hero_title_1: 'Kemampuanmu',
    hero_title_2: 'bernilai',
    hero_title_3: 'di sini.',
    hero_eyebrow: 'One Stop Services',
    hero_cta_start: 'Mulai Gratis →',
    hero_desc: 'Dari bikin website, ngajar privat, hingga desain logo — setiap keahlian punya pasarnya. Mulai tawarkan atau temukan talent terbaik Indonesia.',
  },
  ...
  en: {
    ...
    login_left_title: 'Welcome',
    login_left_title_em: 'back.',
    login_left_desc: 'Sign in and continue your journey with thousands of Indonesian talent.',
    login_feat_1: 'Post your skills in 2 minutes',
    login_feat_2: 'Chat directly with clients',
    login_feat_3: 'Build reputation with reviews',
    reg_left_title: 'Start',
    reg_left_title_em: 'today.',
    reg_left_desc: 'Free forever. No credit card needed. Sign up in 1 minute.',
    register_role_label: 'I want to:',
    register_offer: 'Offer Services',
    register_offer_sub: 'Post my skills',
    register_find: 'Find Talent',
    register_find_sub: 'Find service providers',
    register_name_label: 'Full Name *',
    label_city: 'City',
    label_phone: 'WhatsApp Number',
    login_testimonial: 'AkuBisa helped me get my first client in 3 days. Best platform for Indonesian freelancers!',
    job_title: '🙋 I Need',
    job_modal_title: '🙋 I Need...',
    btn_post_job_new: '+ Post a Need',
    see_all: 'See All →',
    ...
    hero_title_2: 'matter',
    hero_title_3: 'here.',
    hero_desc: 'From web development, tutoring, to logo design — every skill has its market. Start offering or find the best Indonesian talent.',
    hero_cta_start: 'Start Free →',
    how_simple: 'As simple',
    how_simple_em: 'as that.',
    how_step_1_title: 'Write your skills',
    how_step_1_desc: 'Create a profile and post your offer in 2 minutes. No CV needed, just tell what you can do.',
    how_step_2_title: 'Found by the right clients',
    how_step_2_desc: 'Potential clients find you through categories and search. Your profile works 24/7 for you.',
    how_step_3_title: 'Chat & start collaborating',
    how_step_3_desc: 'Discuss directly on the platform, agree on terms, and start working. All in one place.',
    cat_title: 'All fields,',
    cat_title_2: 'welcome.',
    testi_label: 'Testimonials',
    testi_title: 'They have',
    testi_title_2: 'proven it.',
    cta_title: 'Ready to start',
    cta_title_em: 'today?',
    cta_desc: 'Join thousands of workers and clients who have proven it.',
    cta_btn_register: 'Sign Up Free — Start Now',
    cta_btn_explore: 'Browse Services',
    cta_note: 'Free forever · No credit card needed · Sign up in 1 minute',
    how_step_1_title: 'Find Talent',
    how_step_1_desc: 'Browse hundreds of offers from verified talent',
    how_step_2_title: 'Agree & Start',
    how_step_2_desc: 'Chat directly, agree on price, and start the project',
    how_step_3_title: 'Receive & Pay',
    how_step_3_desc: 'Approve the work and complete payment safely',
    how_sub: 'Simple, safe, and trusted',
    footer_desc: 'Indonesian freelance platform connecting local talent with the right clients. Every skill is valuable.',
    footer_platform: 'Platform',
    footer_category: 'Categories',
    footer_info: 'Info',
    footer_follow: 'Follow Us',
    footer_help: 'Help',
    footer_copyright: '© 2025 AkuBisa. Made with ❤️ for Indonesian talent.',
  }
};
